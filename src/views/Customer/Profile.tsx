    ...
    <div className="animate-slide-up" style={{ minHeight: '100vh', background: '#F9FAFB' }}>
      ...
      <div style={{ padding: '1.5rem 1.25rem' }}>
        <div className="flex-col gap-5" style={{ display: 'flex' }}>
          ...
          <hr style={{ border: 'none', marginTop: '1rem', backgroundColor: 'white' }} />
          ...
          <div style={{ marginTop: '1rem' }}>
            <h3 style={{ fontSize: '0.75rem', fontWeight: 800, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.1em', marginLeft: '1rem', marginBottom: '0.75rem' }}>Account Deletion</h3>
            <div className="product-card" style={{ padding: '1.5rem', border: '1px solid #FEE2E2', background: 'linear-gradient(to bottom, #FFF, #FFF7F7)', borderRadius: '24px' }}>
              <div className="flex items-center gap-4 mb-3">
                <div style={{ background: '#FEE2E2', color: '#EF4444', padding: '.5rem', borderRadius: '10px' }}>
                  <Trash2 size={18} />
                </div>
